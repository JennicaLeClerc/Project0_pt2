...
public class UserService {
    ...
    */
    ...
    /**
     * Overloading Withdraw. Does the same as above but specifically asks the User
     * how much they want to withdraw. If the amount was returned null they wanted
     * exit withdraw screen, so exits to Withdraw Menu Page.
     */
    ...
    /**
     * Asks the User how much they would like to withdraw. The Amount (int) must be
     * non-zero and  a multiple of 20. Returns a double Amount. Returns the Amount
     * as null if Amount is not an integer and Exits to Withdraw Menu Page.
     */
     ...
     * the balance(s) for those chosen. Tells you the Account Doesn't Exist if invalid
     * account given.
     */
